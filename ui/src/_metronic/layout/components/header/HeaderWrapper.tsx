...
const HeaderWrapper = () => {
  ...
  return (
    <div id='kt_app_header' className='app-header' style={{backgroundColor: '#153a81'}}>
      <div
          ...
          <div className='d-flex align-items-center flex-grow-1 flex-lg-grow-0 me-lg-15'>
            <Link to='/dashboard'>
              {config.layoutType !== 'dark-header' ? (
                <img
                  alt='Logo'
                  src={toAbsoluteUrl('/media/images/emarat.png')}
                  className='h-40px h-lg-70px app-sidebar-logo-default'
                />
              ) : (
                <>
                  <img
